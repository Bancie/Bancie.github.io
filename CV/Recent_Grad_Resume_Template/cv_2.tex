...
%   \textbf{University Email:} & \href{mailto:}{} \\
  ...
  \begin{position}
    ...
    \begin{itemize}
      ...
      \item \href{https://wandb.ai/chibangn1-https-bancie-github-io-tilearn-/denseuav-baseline/reports/DenseUAV-Non-GPS-Training-Performance--VmlldzoxNjE5NDMwOQ?accessToken=hl4axuavbu3up6rygu5oy7r3ru3jiwwlg285ax59kdhonfcqgx2n0nhmwex4rfob}{W\&B Report}: Training performance of the DenseUAV Non-GPS self-positioning model (loss curves, convergence, best checkpoint).
      \item \href{https://huggingface.co/Bancie/UAV-Self-Positioning-23M-ZCN}{Hugging Face}
      \item \href{https://github.com/Bancie/denseUAV_baseline}{GitHub}
    \end{itemize}
  \end{position}
...
\par
\href{https://sgu.edu.vn}{\textbf{Methods for Integer Linear Programming Problems}} (5/2024): University-level scientific research project at Saigon University (SGU), Vietnam.
\begin{itemize}
