...
% Page numbers in footer (res.cls defaults to empty)
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancyhf{}
...
%   \textbf{University Email:} & \href{mailto:}{} \\
  ...
  \begin{position}
    ...
    \begin{itemize}
      \item Developed and evaluated a DenseUAV baseline (ViT image embeddings) for embedding-based cross-view retrieval and localization on UAV and satellite imagery.
...
\end{itemize}
  ...
  \begin{itemize}
    ...
    \item Designed and built a relational MySQL database from scratch, then deployed and operated it in production.
  ...
  \par
  \textbf{Reading Performance} (7/2025): A personal system to collect essential life data.
  \begin{itemize}
...
\printbibliography[heading=none]
  ...
  \section{STRENGTHS}
  \textbf{Soft skills}: Collaborative research, Open-source contribution, Fast adaptability, Self-driven learning.
  \\
  \textbf{AI/ML}: Full-stack ML/DL, Computer Vision (Detection, Segmentation, Classification, etc.).
  \\
  \textbf{Programming}: Python, PyTorch, Scikit-learn, Pandas, NumPy, FastAPI, LangChain, Docker, MCP, GPU Computing (Modal AI), Weights \& Biases.
  \\
  \textbf{Others}: Discrete Optimization, Scheduling \& Logistics, Operations Research, Applied Mathematics.
  ...
  Computational Science and Artificial Intelligence Research Institute\\
  \href{mailto:huy.lm@vlu.edu.vn}{huy.lm@vlu.edu.vn}\\
  Van Lang University, Ho Chi Minh Citay, Vietnam
